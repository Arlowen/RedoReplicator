/*
 * Java translation derived from OpenLogReplicator src/parser/OpCode0B02.h
 *
...
public final class OpCode0B02 {
    private final RedoByteReader byteReader;

    public OpCode0B02(RedoByteReader byteReader) {
        this.byteReader = byteReader;
    }

    public void process(RedoLogRecord record) {
        RedoFieldCursor fields = RedoOpCodeSupport.readRowHeaders(
                byteReader, record, 0x0B0201);
        if (fields != null) {
            RedoOpCodeSupport.readRowColumns(record, fields, "11.2");
        }
    }
}
