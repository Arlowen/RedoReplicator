/*
 * Java translation derived from OpenLogReplicator src/parser/OpCode0B06.h
 *
...
public final class OpCode0B06 {
    private final RedoByteReader byteReader;

    public OpCode0B06(RedoByteReader byteReader) {
        this.byteReader = byteReader;
    }

    public void process(RedoLogRecord record) {
        RedoFieldCursor fields = RedoOpCodeSupport.readRowHeaders(
                byteReader, record, 0x0B0601);
        if (fields != null) {
            RedoOpCodeSupport.readRowColumns(record, fields, "11.6");
        }
    }
}
